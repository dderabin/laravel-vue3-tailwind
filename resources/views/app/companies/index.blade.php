...
<main class="-mt-24 pb-8">
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-4 lg:max-w-7xl lg:px-8">
              ...
              <div class="sm:flex sm:items-center sm:justify-between">
                <div class="sm:flex sm:space-x-5">
                  <div class="mt-4 text-center sm:mt-0 sm:pt-1 sm:text-left">
                    <p class="text-sm font-medium text-gray-600">Denis Project</p>
                    <p class="text-xl font-bold text-gray-900 sm:text-2xl">@lang('crud.companies.index_title')</p>
                            ...
                            <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                                <table class="mb-4 bg-transparent divide-y divide-gray-200 w-full">
                                    <thead class="bg-gray-50">
                                        <tr>
                                            <!-- <th scope="col" class="px-4 py-3 text-left text-xs font-medium text-gray-900 uppercase tracking-wider">
